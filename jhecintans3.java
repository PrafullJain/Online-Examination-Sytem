...
public class jhecintans3 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from jint where sno=5";
			...
			rs1.close();
			String q2="select * from jint where sno=6";
...
public static void main(String[] args) {
	jhecintans3 c1=new jhecintans3();
