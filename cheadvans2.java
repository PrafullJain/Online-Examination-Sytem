...
public class cheadvans2 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cadv where sno=3";
			...
			rs1.close();
			String q2="select * from cadv where sno=4";
