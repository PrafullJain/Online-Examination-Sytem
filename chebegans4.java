...
public class chebegans4 extends JFrame implements WindowListener{
	...
	public chebegans4() {
		...
		try
		{
			...
			String q1="select * from cbeg where sno=7";
			...
			rs1.close();
			String q2="select * from cbeg where sno=8";
