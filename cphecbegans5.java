...
public class cphecbegans5 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cpbeg where sno=9";
			...
			rs1.close();
			String q2="select * from cpbeg where sno=10";
...
public static void main(String[] args) {
	cphecbegans5 c1=new cphecbegans5();
