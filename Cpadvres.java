...
public class Cpadvres extends JFrame implements WindowListener{
	JButton b,chekbtn;
	UIManager um;
	...
	Cpadvres()
	{
		...
		try
		{
			...
			String q1="select * from cpadv where sno=1";
			...
			rs1.close();
			String q2="select * from cpadv where sno=2";
			...
			rs2.close();
			String q3="select * from cpadv where sno=3";
			...
			rs3.close();
			String q4="select * from cpadv where sno=4";
			...
			rs4.close();
			String q5="select * from cpadv where sno=5";
			...
			rs5.close();
			String q6="select * from cpadv where sno=6";
			...
			rs6.close();
			String q7="select * from cpadv where sno=7";
			...
			rs7.close();
			String q8="select * from cpadv where sno=8";
