...
public class chebegans5 extends JFrame implements WindowListener {
	...
	public chebegans5() {
		...
		try
		{
			...
			String q1="select * from cbeg where sno=9";
			...
			rs1.close();
			String q2="select * from cbeg where sno=10";
