...
public class cphecadvans3 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cpadv where sno=5";
			...
			rs1.close();
			String q2="select * from cpadv where sno=6";
...
public static void main(String[] args) {
	cphecadvans3 c1=new cphecadvans3();
