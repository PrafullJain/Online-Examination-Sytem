...
public class cphecintans4 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cpint where sno=7";
			...
			rs1.close();
			String q2="select * from cpint where sno=8";
...
public static void main(String[] args) {
	cphecintans4 c1=new cphecintans4();
