...
public class cheintans2 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cint where sno=3";
			...
			rs1.close();
			String q2="select * from cint where sno=4";
