...
public class cheintans5 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cint where sno=9";
			...
			rs1.close();
			String q2="select * from cint where sno=10";
