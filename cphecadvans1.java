...
public class cphecadvans1 extends JFrame implements WindowListener{
	...
	public cphecadvans1() {
		...
		l12.setBounds(166,395,760,70);
		l13.setBounds(56,410,360,120);
		l14.setBounds(193,436,760,70);
...
public static void main(String[] args) {
	cphecadvans1 c1=new cphecadvans1();
