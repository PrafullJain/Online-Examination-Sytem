...
public class jhecintans5 extends JFrame implements WindowListener{
	...
	public jhecintans5() {
		...
		l12.setBounds(166,395,560,70);
		l13.setBounds(56,410,360,120);
		l14.setBounds(193,436,860,70);
	...
	try
		{
			...
			String q1="select * from jint where sno=9";
			...
			rs1.close();
			String q2="select * from jint where sno=10";
...
public static void main(String[] args) {
	jhecintans5 c1=new jhecintans5();
