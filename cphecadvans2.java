...
public class cphecadvans2 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cpadv where sno=3";
			...
			rs1.close();
			String q2="select * from cpadv where sno=4";
...
public static void main(String[] args) {
	cphecadvans2 c1=new cphecadvans2();
