...
public class cheadvans3 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cadv where sno=5";
			...
			rs1.close();
			String q2="select * from cadv where sno=6";
