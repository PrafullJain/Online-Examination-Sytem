...
public class cphecbegans4 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cpbeg where sno=7";
			...
			rs1.close();
			String q2="select * from cpbeg where sno=8";
...
public static void main(String[] args) {
	cphecbegans4 c1=new cphecbegans4();
