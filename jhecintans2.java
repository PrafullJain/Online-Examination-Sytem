...
public class jhecintans2 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from jint where sno=3";
			...
			rs1.close();
			String q2="select * from jint where sno=4";
...
public static void main(String[] args) {
	jhecintans2 c1=new jhecintans2();
