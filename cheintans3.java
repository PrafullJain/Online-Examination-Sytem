...
public class cheintans3 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cint where sno=5";
			...
			rs1.close();
			String q2="select * from cint where sno=6";
