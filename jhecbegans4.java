...
public class jhecbegans4 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from jbeg where sno=7";
			...
			rs1.close();
			String q2="select * from jbeg where sno=8";
...
public static void main(String[] args) {
	jhecbegans4 c1=new jhecbegans4();
