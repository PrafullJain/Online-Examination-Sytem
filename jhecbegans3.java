...
public class jhecbegans3 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from jbeg where sno=5";
			...
			rs1.close();
			String q2="select * from jbeg where sno=6";
...
public static void main(String[] args) {
	jhecbegans3 c1=new jhecbegans3();
