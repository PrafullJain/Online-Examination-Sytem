...
public class Cpp extends JFrame implements WindowListener
{
	JButton b1,b2,b3;
	UIManager um;
	JLabel l1,l2,l3;
	...
	public Cpp()
	{
		...
		b1=new JButton("C++-Beginner");
		b2=new JButton("C++-Intermediate");
		b3=new JButton("C++-Advance");
		
		b1.setFont(f1);	b2.setFont(f1);	b3.setFont(f1);
		
		b1.setBounds(120,270,240,100);
		b2.setBounds(540,270,280,100);
		b3.setBounds(960,270,260,100);
		addWindowListener(this);
		add(l1);add(l2);add(l3);
		add(b1);add(b2);add(b3);
		
		l3.setForeground(Color.RED);
		b1.setForeground(Color.BLUE);b2.setForeground(Color.ORANGE);b3.setForeground(Color.MAGENTA);
