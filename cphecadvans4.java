...
public class cphecadvans4 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cpadv where sno=7";
			...
			rs1.close();
			String q2="select * from cpadv where sno=8";
...
public static void main(String[] args) {
	cphecadvans4 c1=new cphecadvans4();
