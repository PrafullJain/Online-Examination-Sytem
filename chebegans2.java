...
public class chebegans2 extends JFrame implements WindowListener {
	...
	public chebegans2() {
		...
		try
		{
			...
			String q1="select * from cbeg where sno=3";
			...
			rs1.close();
			String q2="select * from cbeg where sno=4";
