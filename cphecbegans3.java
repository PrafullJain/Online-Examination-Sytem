...
public class cphecbegans3 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cpbeg where sno=5";
			...
			rs1.close();
			String q2="select * from cpbeg where sno=6";
...
public static void main(String[] args) {
	cphecbegans3 c1=new cphecbegans3();
