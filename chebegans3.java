...
public class chebegans3 extends JFrame implements WindowListener{
	...
	public chebegans3() {
		...
		try
		{
			...
			String q1="select * from cbeg where sno=5";
			...
			rs1.close();
			String q2="select * from cbeg where sno=6";
