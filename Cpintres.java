...
public class Cpintres extends JFrame implements WindowListener{
	JButton b,chekbtn;
	UIManager um;
	...
	Cpintres()
	{
		...
		try
		{
			...
			String q1="select * from cpint where sno=1";
			...
			rs1.close();
			String q2="select * from cpint where sno=2";
			...
			rs2.close();
			String q3="select * from cpint where sno=3";
			...
			rs3.close();
			String q4="select * from cpint where sno=4";
			...
			rs4.close();
			String q5="select * from cpint where sno=5";
			...
			rs5.close();
			String q6="select * from cpint where sno=6";
			...
			rs6.close();
			String q7="select * from cpint where sno=7";
			...
			rs7.close();
			String q8="select * from cpint where sno=8";
			...
			rs8.close();
			String q9="select * from cpint where sno=9";
