...
public class cphecintans5 extends JFrame implements WindowListener{
	...
	public cphecintans5() {
		...
		l6.setBounds(166,230,460,70);
		l7.setBounds(56,250,360,120);
		l8.setBounds(193,276,460,70);
	...
	try
		{
			...
			String q1="select * from cpint where sno=9";
			...
			rs1.close();
			String q2="select * from cpint where sno=10";
...
public static void main(String[] args) {
	cphecintans5 c1=new cphecintans5();
