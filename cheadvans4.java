...
public class cheadvans4 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cadv where sno=7";
			...
			rs1.close();
			String q2="select * from cadv where sno=8";
