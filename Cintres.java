...
public class Cintres extends JFrame implements WindowListener{
	JButton b,chekbtn;
	UIManager um;
	...
	Cintres()
	{
		...
		try
		{
			...
			String q1="select * from cint where sno=1";
			...
			rs1.close();
			String q2="select * from cint where sno=2";
			...
			rs2.close();
			String q3="select * from cint where sno=3";
			...
			rs3.close();
			String q4="select * from cint where sno=4";
			...
			rs4.close();
			String q5="select * from cint where sno=5";
			...
			rs5.close();
			String q6="select * from cint where sno=6";
			...
			rs6.close();
			String q7="select * from cint where sno=7";
			...
			rs7.close();
			String q8="select * from cint where sno=8";
			...
			rs8.close();
			String q9="select * from cint where sno=9";
			...
			rs9.close();
			String q10="select * from cint where sno=10";
			OracleResultSet rs10=(OracleResultSet) stmt.executeQuery(q10);
			while(rs10.next())
			{
				s19=rs10.getString("CANSWER");
				s20=rs10.getString("UANSWER");
				if(s19.equalsIgnoreCase(s20))
				{
					c=c+1;
				}
			}
