...
public class Jaintres extends JFrame implements WindowListener {
	JButton b,chekbtn;
	UIManager um;
	...
	Jaintres()
	{
		...
		l7=new JLabel("Intermediate + Advanced");
		...
		try
		{
			...
			String q1="select * from jint where sno=1";
			...
			rs1.close();
			String q2="select * from jint where sno=2";
			...
			rs2.close();
			String q3="select * from jint where sno=3";
			...
			rs3.close();
			String q4="select * from jint where sno=4";
			...
			rs4.close();
			String q5="select * from jint where sno=5";
			...
			rs5.close();
			String q6="select * from jint where sno=6";
			...
			rs6.close();
			String q7="select * from jint where sno=7";
			...
			rs7.close();
			String q8="select * from jint where sno=8";
