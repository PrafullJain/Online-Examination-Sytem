...
public class cheintans4 extends JFrame implements WindowListener {
	...
	try
		{
			...
			String q1="select * from cint where sno=7";
			...
			rs1.close();
			String q2="select * from cint where sno=8";
