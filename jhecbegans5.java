...
public class jhecbegans5 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from jbeg where sno=9";
			...
			rs1.close();
			String q2="select * from jbeg where sno=10";
...
public static void main(String[] args) {
	jhecbegans5 c1=new jhecbegans5();
