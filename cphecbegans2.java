...
public class cphecbegans2 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cpbeg where sno=3";
			...
			rs1.close();
			String q2="select * from cpbeg where sno=4";
...
public static void main(String[] args) {
	cphecbegans2 c1=new cphecbegans2();
