...
public class Cpbegres extends JFrame implements WindowListener {
	JButton b,chekbtn;
	UIManager um;
	...
	Cpbegres()
	{
		...
		try
		{
			...
			String q1="select * from cpbeg where sno=1";
			...
			rs1.close();
			String q2="select * from cpbeg where sno=2";
			...
			rs2.close();
			String q3="select * from cpbeg where sno=3";
			...
			rs3.close();
			String q4="select * from cpbeg where sno=4";
			...
			rs4.close();
			String q5="select * from cpbeg where sno=5";
			...
			rs5.close();
			String q6="select * from cpbeg where sno=6";
			...
			rs6.close();
			String q7="select * from cpbeg where sno=7";
			...
			rs7.close();
			String q8="select * from cpbeg where sno=8";
			...
			rs8.close();
			String q9="select * from cpbeg where sno=9";
