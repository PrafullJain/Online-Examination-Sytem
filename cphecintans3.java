...
public class cphecintans3 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cpint where sno=5";
			...
			rs1.close();
			String q2="select * from cpint where sno=6";
...
public static void main(String[] args) {
	cphecintans3 c1=new cphecintans3();
