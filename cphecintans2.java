...
public class cphecintans2 extends JFrame implements WindowListener{
	...
	try
		{
			...
			String q1="select * from cpint where sno=3";
			...
			rs1.close();
			String q2="select * from cpint where sno=4";
...
public static void main(String[] args) {
	cphecintans2 c1=new cphecintans2();
